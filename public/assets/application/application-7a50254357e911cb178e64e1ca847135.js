...
(function() {
  ...
  Graph = (function() {
    function Graph() {
      var graph, graph_url, graphic, id, _i, _len, _ref;
      this.graphs = $('canvas');
      this.form = $('form');
      this.data = {
...
(function() {
  ...
  refreshGraph = (function() {
    function refreshGraph() {
      ...
      this.form.on('submit', (function(_this) {
        return function(e) {
          var graph, graph_url, graphic, id, _i, _len, _ref, _results;
          _ref = _this.graphs;
          _results = [];
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            graph = _ref[_i];
            ...
            _results.push(new Chartkick.AreaChart(id, graph_url));
          }
          return _results;
        };
      })(this));
  ...
  $(function() {
    var refresh_graph;
    if (($('.graph')).length > 0) {
      return refresh_graph = new refreshGraph;
    }
  });
  ...
  SubmitForm = (function() {
    function SubmitForm() {
      ...
      form.on('change', (function(_this) {
        return function(e) {
          var date, date_input, date_parsed, refresh_graph, submit_form, year;
